    ...
    <>
      ...
      {lightbox && (
        <div className="lightbox-overlay" onClick={() => setLightbox(false)}>
          ...
          <div className="lightbox-label">{SLIDES[active].label} {active + 1}/{SLIDES.length}</div>
        </div>
      )}
    </>
  );
    ...
    <div className="iws-page cyber-bg">
      ...
      <div className="wrap">
            ...
            <div className="hero-split">
              ...
              <div className="hero-report">
                <div className="paper-frame">
                  ...
                  <ReportSlideshow ref={slideshowRef} />
                </div>
          ...
          <div className="split">
            <div>
              ...
              <ul className="feature-list">
                {[
                  { title: "9-seitiger PDF-Report", desc: "Executive Summary für die GF, technischer Anhang für die IT. Ein Dokument für zwei Zielgruppen." },
            ...
            <div>
              <div className="paper-frame">
                <div className="paper-bar">
                  ...
                  <span className="paper-title">Exposure Report (Beispiel)</span>
                  <span className="paper-anon">Anonymisiert</span>
                  <button className="paper-expand" onClick={() => slideshowRef2.current?.open()} aria-label="Vergrößern">
                    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" y1="3" x2="14" y2="10"/><line x1="3" y1="21" x2="10" y2="14"/></svg>
                  </button>
                </div>
                <ReportSlideshow ref={slideshowRef2} />
              </div>
              <p className="hero-report-note">9 Abschnitte, Executive Summary, CVE-Übersicht</p>
            </div>
          </div>
        ...
        <div className="section">
          ...
          <div className="grid2">
            ...
            <div className="card">
              ...
              <p style={{ fontSize: "13px", color: "#64748b", marginBottom: "16px", lineHeight: 1.6 }}>Sicherheitsinvestitionen brauchen ein Fundament. Dieser Report liefert es, verständlich und ohne IT-Vorkenntnisse.</p>
              <ul className="checklist">
        ...
        <div className="section">
          ...
          <h2 style={{ marginBottom: "32px" }}>Von Anfrage bis Report in 48h.</h2>
          <div className="steps">
      ...
      <style jsx global>{`
        ...
        .iws-page .paper-frame { background: #ffffff; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 8px 32px rgba(0,0,0,0.1), 0 1px 4px rgba(0,0,0,0.05); overflow: hidden; transition: box-shadow 0.3s ease; }
        .iws-page .paper-frame:hover { box-shadow: 0 12px 40px rgba(0,0,0,0.13); }
        ...
        .iws-page .slide-expand { position: absolute; top: 10px; right: 10px; width: 28px; height: 28px; border-radius: 6px; border: 1px solid rgba(71,85,105,0.2); background: rgba(248,250,252,0.9); color: #475569; display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 2; transition: background 0.15s; }
        .iws-page .slide-expand:hover { background: #fff; border-color: #334155; color: #0f172a; }
        ...
        .iws-page .hero-box { position: relative; overflow: hidden; border: 1px solid rgba(71,85,105,0.25); border-radius: 32px; padding: 48px 32px; background: rgba(255,255,255,0.85); box-shadow: 0 2px 20px rgba(0,0,0,0.06); transition: box-shadow 0.3s ease; }
        ...
        @media (max-width: 640px) {
          .iws-page .wrap { padding: 32px 16px 0; }
          .iws-page .hero { padding: 24px 0 16px; }
          .iws-page .hero-box { padding: 20px 16px; border-radius: 20px; }
          .iws-page .hero-split { grid-template-columns: 1fr; gap: 24px; }
          .iws-page .hero-text { text-align: center; }
          .iws-page .hero-sub { font-size: 15px; text-align: left; max-width: 100%; }
          .iws-page .cta-row { justify-content: center; }
          .iws-page .badge { font-size: 10px; padding: 4px 10px; white-space: normal; text-align: center; }
          .iws-page .grid3 { grid-template-columns: 1fr; }
          .iws-page .grid2 { grid-template-columns: 1fr; }
          .iws-page .split { grid-template-columns: 1fr; gap: 28px; }
          .iws-page .steps { grid-template-columns: 1fr; gap: 0; text-align: left; }
          .iws-page .step { display: flex; align-items: flex-start; gap: 16px; text-align: left; padding: 16px 0; border-bottom: 1px solid #e2e8f0; }
          .iws-page .step:last-child { border-bottom: none; }
          .iws-page .step-num { margin: 0; flex-shrink: 0; width: 40px; height: 40px; font-size: 15px; }
          .iws-page .price-card { padding: 24px 20px; }
          .iws-page .price-num { font-size: 42px; }
          .iws-page .final { padding: 36px 20px; }
          .iws-page .partner-logo-img { height: 70px; }
          .iws-page .paper-frame { transform: none; }
          .iws-page .faq-list { max-width: 100%; }
          .iws-page .trust { gap: 8px 16px; font-size: 12px; padding: 12px 16px; }
        }
      `}</style>
    </div>
  );
