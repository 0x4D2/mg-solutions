      ...
      <div className="cyber-bg min-h-screen">
        <section className="py-16">
          <div className="container mx-auto px-4 pb-40">
            <h1 className="site-title gradient-text text-center">Impressum</h1>
            <div className="mt-8 text-white text-lg leading-relaxed">
              ...
              <p className="mt-4">
                ...
                <br />
                Die Informationen auf dieser Website sind allgemeiner Natur und
                stellen keine rechtliche Beratung dar. MG Solutions übernimmt
                keine Haftung für die Richtigkeit, Vollständigkeit oder
                Aktualität der bereitgestellten Informationen. Die Nutzung der
