...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (typeof window.grecaptcha === "undefined") {
      setRecaptchaError(
        "reCAPTCHA konnte nicht geladen werden. Bitte versuchen Sie es später erneut.",
      );
      return;
    }
    const token = await window.grecaptcha.execute(
      "6LeFzm4rAAAAAAVjzEG_0riyYW7dcMdJlOIDWfIJ",
      { action: "submit" },
    );
    if (!token) {
      setRecaptchaError(
      ...
      <main className="cyber-bg bg-gray-900 text-white min-h-screen">
        ...
        <section className="relative py-15 bg-gradient-to-br from-blue-900 via-gray-900 to-gray-900 text-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              Ihre Daten sind bei uns geschützt – wir antworten innerhalb von 24
              Stunden.
            </motion.p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-3xl text-white">
            ...
            >
              {sent ? (
                <div className="text-center py-8">
                  <h2 className="site-title gradient-text text-2xl sm:text-3xl mb-2">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="mt-5 flex justify-center">
                      <a
                        href="/"
                        className="inline-flex items-center justify-center px-4 py-2 rounded-md font-medium bg-cyan-500/10 text-cyan-300 hover:bg-cyan-500/20"
                      >
                        Zur Startseite
                      </a>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option
                          value="general"
                          title="Für alles, was nicht spezifisch passt"
                        >
                          Allgemeine Anfrage
                        </option>
                        <option
                          value="report"
                          title="Für direkte Anforderung des kostenlosen Exposure-Reports"
                        >
                          Kostenlose Ersteinschätzung / Exposure-Report
                        </option>
                        <option
                          value="consulting"
                          title="Für tiefergehende Analyse oder Sicherheitsstrategie"
                        >
                          Beratung / Sicherheitsstrategie
                        </option>
                        <option
                          value="pricing"
                          title="Für Anfragen zu Preisen und Angeboten"
                        >
                          Angebot / Preisinfos
                        </option>
                        <option
                          value="support"
                          title="Support-Anfragen oder Rückfragen zu Reports"
                        >
                          Support / Rückfragen zu Report
                        </option>
                        <option value="other" title="Sonstiges">
                          Sonstiges
                        </option>
                      </select>
                    </div>
                  ...
                  >
                    ...
                    <label htmlFor="privacy" className="text-white text-base">
                      Ja, ich möchte Antworten auf meine Frage erhalten und
                      akzeptiere die{" "}
                      <a
                        href="/privacy"
                  ...
                  {error && (
                    <div className="text-red-500 font-semibold mt-1 text-center">
                      {error}
                    </div>
                  )}
                  {recaptchaError && (
            ...
            <div className="flex justify-center gap-6 mt-8 text-white">
              <div className="flex flex-col items-center">
                <div
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-[rgba(20,28,43,0.65)] mb-2"
        ...
        <div className="text-center text-blue-300 text-sm mt-8">
          Mehr zum Umgang mit Ihren Daten finden Sie in unserer{" "}
          <a
            href="/privacy"
