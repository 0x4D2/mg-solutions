        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-8 text-white text-lg leading-relaxed">
              <p>
                <strong>1. Allgemeine Hinweise:</strong>
                <br />
              ...
              <p className="mt-4">
                ...
                <br />
                Memo Güngör (Inhaber von MG Solutions)
                <br />
              ...
              <p className="mt-4">
                <strong>3. Gesammelte personenbezogene Daten:</strong>
                <br />
                ...
                <br />- (Falls relevant) Zahlungsdaten
              </p>
              <p className="mt-4">
                <strong>4. Zweck der Datenerhebung:</strong>
                <br />
                Die Erhebung und Verarbeitung Ihrer Daten erfolgt zu folgenden
                Zwecken:
                <br />
                - Kontaktaufnahme
                <br />
              ...
              <p className="mt-4">
                ...
                Verarbeitung widersprechen und Ihr Recht auf
              ...
              <p className="mt-4">
                ...
                info@ichwillsicherheit.de kontaktieren.
              </p>
              <p className="mt-4">
                <strong>7. Rechtsgrundlage der Datenverarbeitung:</strong>
                <br />
                ...
                <br />
                - Aufgrund Ihrer Einwilligung (lit. a).
                <br />- Zur Wahrung berechtigter Interessen (lit. f), sofern
              ...
              <p className="mt-4">
                ...
                wie es für die Erfüllung der oben genannten Zwecke erforderlich
                ist oder wie es gesetzliche Aufbewahrungsfristen vorsehen. Nach
                Ablauf dieser Fristen werden die Daten gelöscht.
              </p>
              <p className="mt-4">
                <strong>9. Cookies und Tracking:</strong>
                <br />
                Unsere Website verwendet Cookies, um die Benutzerfreundlichkeit
                zu verbessern und bestimmte Funktionen bereitzustellen. Weitere
              ...
              <p className="mt-4">
                <strong>10. Weitergabe von Daten an Dritte:</strong>
                <br />
                Ihre Daten werden nur an Dritte weitergegeben, wenn dies zur
                Erfüllung eines Vertrags erforderlich ist, Sie ausdrücklich
                eingewilligt haben oder wir gesetzlich dazu verpflichtet sind.
