      ...
      <main className="cyber-bg bg-gray-900 text-white min-h-screen flex-grow relative z-10">
        <section className="pt-16 sm:pt-20 pb-20 sm:pb-28 max-w-4xl mx-auto px-4 sm:px-8">
          <h1 className="site-title gradient-text text-center">
            Unsere Roadmap – Schritt für Schritt zum Überblick
          </h1>

          <div className="space-y-16">
            <div
              className="max-w-4xl mx-auto rounded-2xl p-8 sm:p-10 text-white card"
              style={{
            ...
            >
              <h3 className="font-semibold text-lg cyan-text">
                Exposure-Reports
              </h3>
              <p className="mt-2 text-gray-300">
                Monatliche Analysen Ihrer externen Sichtbarkeit – objektiv,
                passiv, sofort nutzbar.
              </p>
            ...
            >
              <h3 className="font-semibold text-lg cyan-text">
                IN ENTWICKLUNG — Erweiterte Insights & Trends
              </h3>
              <p className="mt-2 text-gray-300">
                Langfristige Entwicklung Ihrer Sicherheitslage nachvollziehbar
                machen.
              </p>
              <ul className="mt-3 text-gray-200 list-disc list-inside">
            ...
            >
              <h3 className="font-semibold text-lg cyan-text">
                IN PLANUNG — Dashboard & Automation
              </h3>
              <p className="mt-2 text-gray-300">
                Alles auf einen Blick – Entwicklungen, Reports und Warnungen
            ...
            >
              ...
              <p className="mt-2 text-gray-300">
                Schrittweise, transparent und praxisnah. Keine leeren
                Versprechen, kein Security‑Theater. Wir zeigen nur, was wirklich
                sichtbar ist – nicht, was theoretisch möglich wäre.
              </p>
              <blockquote className="mt-3 italic text-gray-200">
                „Wir liefern Klarheit statt Komplexität.“
              </blockquote>
            </div>
            ...
            >
              ...
              <p className="mt-2 text-gray-300">
                Teilen Sie sie mit uns – wir priorisieren gemeinsam.
              </p>
              <div className="mt-4">
                <Link
                  href="/contact"
